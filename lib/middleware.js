 ...
 * @param frameworks karma loaded fmws
 ...
 */
function writeKarmaSharderInfo(log, frameworks, config, request, response) {
...
module.exports = function(logger, config) {
  ...
  return function (request, response, next) {
    ...
    if (request.url.indexOf(karmaParallelScriptName) !== -1) {
      return writeKarmaSharderInfo(log, frameworks, config.parallelOptions, request, response);
    }
